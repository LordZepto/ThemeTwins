 ...
 * @uses themetwins_header_style() to style front-end.
...
function themetwins_custom_header_setup() {
	$args = array(
		...
		'wp-head-callback'       => 'themetwins_header_style',
		'admin-head-callback'    => 'themetwins_admin_header_style',
		'admin-preview-callback' => 'themetwins_admin_header_image',
	);

	add_theme_support( 'custom-header', $args );
}
add_action( 'after_setup_theme', 'themetwins_custom_header_setup' );
